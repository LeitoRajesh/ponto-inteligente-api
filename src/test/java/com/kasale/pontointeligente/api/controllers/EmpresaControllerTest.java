...
public class EmpresaControllerTest {
	...
	public void testBuscarEmpresaCnpjInvalido() throws Exception{
		...
		mvc.perform(MockMvcRequestBuilders.get(BUSCAR_EMPRESA_CNPJ_URL.concat(CNPJ)).accept(MediaType.APPLICATION_JSON))
			.andExpect(status().isBadRequest())
			.andExpect(jsonPath("$.erros").value("Empresa não encontrada para o CNPJ ".concat(CNPJ)));
	}
	...
	public void testBuscarEmpresaCnpjValido() throws Exception{
		...
		mvc.perform(MockMvcRequestBuilders.get(BUSCAR_EMPRESA_CNPJ_URL.concat(CNPJ))
